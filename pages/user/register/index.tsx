                  ...
                  <div className="pt30">
                    ...
                    <form className="pt10" onSubmit={registerStart} method="POST">
                      <div className="field">
                        ...
                        <input type="text" name="username" maxLength={24} autoFocus required id="id_username" />
                      </div>
                      ...
                      <div className="mt30">
                        <div>
                          <input id="kiyakuInput" onClick={changeAccept} className="mr20" type="checkbox" />
                          <a className="active" id="kiyakuOpen" onClick={openModal}>利用規約</a>に同意します。
                        </div>
                        { accept ? 
                          <button className="pt5 mt20 pb5 wM500px btFormat1 btNormal" id="regiSub" type="submit">会員登録</button> :
                          <button className="pt5 mt20 pb5 wM500px btFormat1 btNormal" id="regiSub" type="submit" disabled>会員登録</button>
                        }
                      </div>
                    </form>

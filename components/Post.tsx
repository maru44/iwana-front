              ...
              <div className="mt20">
                <form className="field">
                  ...
                  <input
                    ...
                    maxLength={36}
                    form="postData"
                    defaultValue={wanted ? wanted.want_name : undefined}
                  ></input>
                </form>
                <form className="field mt20">
                  ...
                  <input
                    ...
                    name="want_price"
                    form="postData"
                    defaultValue={wanted ? wanted.want_price : undefined}
                  ></input>
                </form>
                <div className="field mt20">
                  ...
                  <div className="mt10">
                    ...
                    <form
                      onSubmit={checkAll}
                      className="flexNormal mt5 alCen"
                      id="want_plat"
                    >
                      <div className="mr20">
                  ...
                  <form className="field mt20">
                    ...
                    <textarea
                      ...
                      maxLength={800}
                      id="id_want_intro"
                      defaultValue={wanted ? wanted.want_intro : undefined}
                    ></textarea>
                  </form>
                </div>
                {wanted ? (
                  <form
                    onSubmit={editWanted}
                    id="postData"
                    className="field mt30"
                    data-wanted={wanted.slug}
                  >
                    <button
                      type="submit"
                      className="btFormat1 btNormal wM500px pt5 pb5"
                    >
                      編集する
                    </button>
                  </form>
